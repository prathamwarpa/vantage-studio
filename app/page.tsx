      ...
      <div className="relative z-10">
        ...
        <footer className="border-t border-white/10 bg-black">
          <div className="mx-auto flex w-full max-w-[1280px] items-center justify-between px-5 py-4 md:px-8 md:py-5">
            ...
            <nav aria-label="Social links" className="flex flex-wrap gap-6 text-[11px] tracking-[0.2em] text-zinc-400">
              <a href="#">INSTAGRAM</a>
              <a href="#">LINKEDIN</a>
              <a href="#">TWITTER</a>
              <a href="#">PRIVACY</a>
            </nav>
            <p className="text-[11px] tracking-[0.14em] text-zinc-500">© 2026 OBSIDIAN GALLERY. ALL RIGHTS RESERVED.</p>
          </div>
        </footer>
      </div>
    </div>
